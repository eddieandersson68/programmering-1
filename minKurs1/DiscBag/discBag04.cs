...
namespace DiscBag
{
    class MinDiscBag
    {
        ...
        //{
        //    int sum = 0;
        //    foreach (temp in discBag)
        //    for (int i = 0; i < discBag.Length; i++)
        //    {
        //        Price += sum = sum + Disc(Price);
        //    }
        //    return  sum;
        ...
        {
            public Driver(string Make, string Type, string Name, int Price) : base(Make, Type, Name, Price)
            {
            ...
            //{
            //    discar[0] = new Driver("Lattitude", "Driver", "Freedom", 169);
